...
import { selectContractProperties, selectMainProduct } from '@/sites/retail/features/quoteSlize'
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-12'>
                            <div className='col-span-8 lg:col-start-3 flex flex-col gap-6 lg:text-left'>
                                <div className='flex flex-col items-center lg:flex-row rounded-[4px] py-6 px-10 bg-primary/20 gap-6'>
                                    ...
                                    <div>
                                        <div className='font-bold text-xl'>{t('Grazie per aver acquistato la tua nuova {{productName}} personalizzata!', { productName: mainProduct.label })}</div>
                                        <div className='text-lg'><span className='italic'>{t('Consegna stimata')}:</span> {shippingDate}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='col-span-8 lg:col-start-3 flex flex-col gap-6 text-left'>
                                <div className='flex flex-col gap-4'>
                                    ...
                                    <div className='border-2 p-4 flex flex-col gap-4 rounded'>
                                        <div className='font-bold'>{contract.firstName} {contract.lastName}</div>
                                        ...
                                        <div>
                                            ...
                                            <div>{contract.addressContract_zipCode} {contract.addressContract_city}, {contract.addressContract_province}</div>
                                        </div>
                                    </div>
                                </div>
                                <div className='flex flex-col gap-4'>
                                    ...
                                    <div className='border-2 p-4 flex flex-col gap-4 rounded'>
                                        <div>
                                            ...
                                            <div>{contract.billingAddress_zipCode} {contract.billingAddress_city}, {contract.billingAddress_province}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
