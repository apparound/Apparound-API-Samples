...
import { selectFlatCart, selectSizeProducts } from '@/sites/retail/features/quoteSlize'
                        ...
                        {item.products.map((product: any, innerIndex: any) => {
                            ...
                            return (
                                <Item
                                    ...
                                    text={product.label}
                                    info={product.activationPrice ? `+${currencyNumberFormat(product.activationPrice)}` : t('Incluso')}
