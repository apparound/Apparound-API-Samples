...
import { selectCartClusters } from '@/sites/retail/features/quoteSlize'
...
const Header = () => {
    ...
    return (
        <div className='w-full border-[#DCE1E6] border-b-2'>
            <Title title={cartClusters.mainCluster.shortName} info={{ label: cartClusters.selectedSize.label }} action={(
                <Button
                    label={t('Modifica')}
                    onClick={() => {
                        navigate(-1)
