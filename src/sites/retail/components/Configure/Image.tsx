...
import { selectColorProduct, selectMainProduct } from '@/sites/retail/features/quoteSlize'
    ...
    return (
        <div className='flex flex-1 h-full px-10 pt-5 pb-10'>
            <div className='flex flex-col w-full h-full items-center overflow-hidden'>
                ...
                <div className='text-left text-[#9B9B9B] max-w-[700px] text-xs'>{t('Il colore visualizzato potrebbe apparire diverso rispetto alla realtà per motivi tecnici. I colori metallici sono particolarmente difficili da rappresentare su uno schermo.')}</div>
            </div>
        </div>
    )
}
